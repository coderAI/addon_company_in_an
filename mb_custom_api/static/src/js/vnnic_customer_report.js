odoo.define('mb_custom_api.vnnic_customer_report', function (require) {
'use strict';
...
var ReportWidget = require('mb_custom_api.ReportWidget');
...
var vnnic_customer_report = Widget.extend(ControlPanelMixin, {
    ...
    get_html: function() {
        var self = this;
        var defs = [];
        return new Model('vnnic.customer.report.context').call('return_context', [self.report_model, self.given_context, self.report_id]).then(function (result) {
...
core.action_registry.add("vnnic_customer_report", vnnic_customer_report);
return vnnic_customer_report;
});
