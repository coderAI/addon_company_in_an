odoo.define('mb_custom_sales.ss_forecast_renew_service_report', function (require) {
'use strict';
...
var ss_forecast_renew_service_report = Widget.extend(ControlPanelMixin, {
    ...
    render_searchview_buttons: function() {
        ...
        // fillter one department
//        this.$searchview_buttons.find('.o_template_reports_one-department').bind('click', function (event) {
//            var report_context = {};
//            var value = $(event.target).parents('li').data('value');
//            console.log(self.report_context.department_id);
//            if(self.report_context.department_id.indexOf(value) === -1){
//                report_context.department_id = value;
//            }
//            else {
//                report_context.remove_department_id = value;
//            }
//            self.restart(report_context);
//        });
        ...
        // fillter multi department funtion click
...
core.action_registry.add("ss_forecast_renew_service_report", ss_forecast_renew_service_report);
return ss_forecast_renew_service_report;
});
