odoo.define('mb_custom_sales.ReportWidget', function (require) {
'use strict';
...
var ReportWidget = Widget.extend({
    ...
    start: function() {
        QWeb.add_template("/mb_custom_sales/static/src/xml/template_report_line.xml");
    ...
    unfold: function(e) {
        ...
        return this.context_model.call('add_line', [[parseInt(context_id, 10)], parseInt(active_id, 10)]).then(function () { // First add the line to the model
            ...
            if (!isLoaded) { // If the lines have not yet been loaded
                ...
                new Model('ss.forecast.renew.service.report.context').call('get_full_report_name_by_report_name', [report_name]).then(function (result) {
