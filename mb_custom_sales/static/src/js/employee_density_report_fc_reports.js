odoo.define('mb_hr_employee.employee_density_report', function (require) {
'use strict';
...
var ReportWidget = require('mb_hr_employee.ReportWidget');
...
var employee_density_report = Widget.extend(ControlPanelMixin, {
    ...
    get_html: function() {
        var self = this;
        var defs = [];
        return new Model('report.hr.employee.context').call('return_context', [self.report_model, self.given_context, self.report_id]).then(function (result) {
...
core.action_registry.add("employee_density_report", employee_density_report);
return employee_density_report;
});
