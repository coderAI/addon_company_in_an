...
class HrEmployeeReportController(http.Controller):
    ...
    @http.route('/mb_custom_sales/<string:output_format>/<string:report_name>/<string:report_id>', type='http', auth='user')
            ...
            if output_format == 'xlsx':
                response = request.make_response(
                    ...
                    headers=[
                        ...
                        ('Content-Disposition', 'attachment; filename=service_report.xlsx;')
                    ]
                )
