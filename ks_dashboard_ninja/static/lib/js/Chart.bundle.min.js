                    ...
                    (e.angleLines.display || e.pointLabels.display) && function(t) {
                        ...
                        if (s > 0 || n.reverse) {
                            ...
                            if (i.display && 0 !== s && function(t, e, i, n) {
                                    ...
                                    if ((o || s) && l && u) {
                                        if (r.save(), r.strokeStyle = l, r.lineWidth = u, r.setLineDash && (r.setLineDash(e.borderDash || []), r.lineDashOffset = e.borderDashOffset || 0), r.beginPath(), o) r.arc(t.xCenter, t.yCenter, i > 35 ? i : 35, 0, 2 * Math.PI);
                                        else {
